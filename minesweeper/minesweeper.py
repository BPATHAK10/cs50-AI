...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        #get a list of the nearby cells by using nearbyCells function
        nearbyCells = self.nearbyCells(cell)

        #remove any cells in nearby cells they have  already been chosen as a move
        for nearbyCell in nearbyCells:
            if self.moves_made.__contains__(nearbyCell):
                nearbyCells.remove(nearbyCell)
        
        #create a new sentence and add it to the knowlodge base
        ...
        for sentence in self.knowledge:
            if len(sentence.cells) == sentence.count:
                tempCells = copy.deepcopy(sentence.cells)
                for c in tempCells:
                    self.mark_mine(c)
        ...
        for sentence1 in tempKnowledge:
            ...
            for sentence2 in self.knowledge:
                ...
                if sentence1 == sentence2 or len(cells2) == 0:
                    continue

                elif cells1.issubset(cells2):
                    setDiff = cells2.difference(cells1)
                    ...
                    self.knowledge.append(Sentence(setDiff,countDiff))
